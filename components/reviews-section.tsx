...
const reviews = [
  ...
  },
  {
    ...
    company: "شركة للتكنولوجيا",
    rating: 5,
    text: "خدمة ممتازة و أنصح كل بالتعامل معها، لأنها تستحق الثقة بجدارة. وبكل تأكيد، هيكون لي تعاملات مستقبلية كتيرة معاها! بجد، شكرًا على المجهود الرائع والإتقان! 🌟",
    image: "/placeholder.svg?height=100&width=100",
  },
  {
    id: 3,
